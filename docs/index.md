...
<figure>
  <img src="images/demo1.png" alt="Demo of diffsan in action" width="100%">
</figure>

<figure>
  <img src="images/demo2.png" alt="Demo of diffsan in action" width="100%">
...
This project is licensed under the Apache-2.0 License. See [LICENSE](https://github.com/caika-lgtm/diffsan/blob/main/LICENSE) for details.
